...
const Logo = ({ className = "w-12 h-12" }: { className?: string }) => {
  return (
    ...
    >
      ...
      {/* Shield Frame */}
      <path
        d="M100 5 L192 38 V100 C192 165 100 198 100 198 C100 198 8 165 8 100 V38 L100 5Z"
        fill="url(#frameGrad)"
      ...
      {/* Shield Interior */}
      <path
        d="M100 18 L178 45 V100 C178 155 100 188 100 188 C100 188 22 155 22 100 V45 L100 18Z"
        fill="#000000"
      />
      <path
        d="M100 18 L178 45 V100 C178 155 100 188 100 188 C100 188 22 155 22 100 V45 L100 18Z"
        fill="radial-gradient(circle at 50% 30%, #4B5563 0%, transparent 80%)"
        opacity="0.4"
      />
      ...
      {[
        ...
        <g key={i}>
          ...
          <path
            d={`M${p.x - 1.5} ${p.y} L${p.x + 1.5} ${p.y} M${p.x} ${p.y - 1.5} L${p.x} ${p.y + 1.5}`}
            stroke="#111827"
            strokeWidth="0.5"
          />
        </g>
      ...
      <text
        ...
        filter="url(#metalShine)"
      >
        <textPath href="#urbanPath" startOffset="50%" textAnchor="middle">
          URBAN
        </textPath>
      </text>
      ...
      <g transform="translate(0, 10)">
        <path
          d="M75 115 C75 105 85 100 85 90 C85 82 80 78 75 78 C70 78 65 82 65 90 C65 95 70 100 70 105 C60 110 55 120 58 135 L75 135 Z"
          fill="#F3F4F6"
          filter="url(#metalShine)"
        />
        <path
          d="M125 115 C125 105 115 100 115 90 C115 82 120 78 125 78 C130 78 135 82 135 90 C135 95 130 100 130 105 C140 110 145 120 142 135 L125 135 Z"
          fill="#F97316"
          filter="url(#metalShine)"
        />
        <rect
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        >
          ...
          <h1 className="text-6xl md:text-8xl font-black mb-6 leading-none uppercase italic tracking-tighter">
            Dominate Your <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-b from-yellow-400 to-orange-600">
              Limits
            </span>
          </h1>
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto mb-10 font-medium">
            Experience world-class training, elite equipment, and a community
            dedicated to crushing goals. Your transformation starts here.
          </p>
  ...
  const features = [
    {
      ...
      description:
        "State-of-the-art machines and free weights designed for maximum efficiency and results.",
    },
    {
      icon: <Shield className="w-8 h-8 text-yellow-500" />,
      title: "Certified Trainers",
      description:
        "Expert coaches dedicated to your form, safety, and personalized progress tracking.",
    },
    {
      icon: <Clock className="w-8 h-8 text-yellow-500" />,
      title: "24/7 Access",
      description:
        "Train on your schedule. Our doors are open around the clock for members.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 max-w-xl mx-auto">
            Tailored programs designed to push you beyond your perceived limits.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500">
            Flexible memberships for every fitness level.
          </p>
        </div>
        <div className="grid md:grid-cols-3 gap-8">
          {plans.map((plan, idx) => (
            ...
            >
              ...
              <h3 className="text-2xl font-bold uppercase italic mb-2">
                {plan.name}
              </h3>
              ...
              <button
                className={`w-full py-4 rounded-xl font-black uppercase tracking-wider transition-all ${plan.popular ? "bg-yellow-500 text-black hover:bg-yellow-400" : "bg-white/10 text-white hover:bg-white/20"}`}
              >
                Get Started
              </button>
            </div>
          ...
          <div className="flex flex-col justify-center">
            <div className="space-y-10">
              <div className="flex items-start gap-6">
                ...
                <div>
                  <h4 className="text-lg font-bold uppercase italic mb-1">
                    Location
                  </h4>
                  <p className="text-gray-400">
                    Plot 123, Block 5, Clifton, Karachi, Pakistan
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-6">
