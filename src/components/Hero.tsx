    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        <div className="max-w-3xl">
          ...
          >
            Urban Fitness provides the best environment, equipment, and
            expert guidance to help you reach your peak physical condition.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <a
              href="#services"
              className="border border-white/30 hover:border-primary px-8 py-3 font-bold uppercase tracking-widest transition-all hover:bg-primary/10 flex items-center justify-center"
            >
              Our Classes
            </a>
          </motion.div>
      ...
      <div className="absolute right-0 bottom-20 hidden lg:block select-none pointer-events-none">
        <span className="text-[20vh] font-black text-white/3 uppercase vertical-text leading-none tracking-tighter">
          Fitness
        </span>
      </div>
    </section>
